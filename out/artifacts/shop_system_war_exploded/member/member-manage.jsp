    ...
    <div class="bk-con-message message-section" id="iframe_box">
        ...
        <form id="myform" action="MemberServlet" method="post">
            <div class="operation  mb15">
                ...
                会员帐号:<input type="text" name="memberNo" value="">
                注册日期从:<input type="date" name="date1" value="">到<input type="date" name="date2" value="">
...
<script>
    function subForm(pageIndex) {
        window.location.href = "MemberServlet?flag=manage&pageIndex=" + pageIndex;
    }
