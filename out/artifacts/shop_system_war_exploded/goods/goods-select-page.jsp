...
<%--                </button>--%>
    ...
    %>
                    <select id="bigCateId" name="bigCateId">
                        <option selected="selected" value="0">大分类</option>
                        <c:forEach var="bigcate" items="${cateList}">
                            <c:if test="${bigcate.id==bigId}">
...
<%--                    <option selected="selected" value="0">小分类</option>--%>
                ...
                <input type="text" name="goodsName" value="${goodsName}" placeholder="查询商品名称">
                    ...
                    <c:forEach var="goods" items="${goodsList}">
                        <tr>
                            ...
                            <td>
                                ...
                                |<a href="GoodsServlet?flag=deleteGoods&id=${goods.id}" onclick="return confirm('确定删除麼?')">删除</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
...
<script>
    function subForm(pageIndex) {
        window.location.href = "GoodsServlet?flag=selectGoods&pageIndex=" + pageIndex;
    }
