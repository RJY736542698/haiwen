            ...
            <div class="page_content clearfix mb15 table-module ">
                <table class="gallery table table_list table_striped table-bordered " id="">
                    ...
                    <c:forEach var="admin" items="${adminList}">
                        <tr>
<%--                            <td><label><input type="hidden" id="id" name="id" value="${admin.id}" class="ace"><span--%>
<%--                                    class="lbl"></span></label></td>--%>
                            ...
                            <td>
                                <a href="RoleServlet?flag=showRole&id=${admin.id}">角色分配</a>
                            </td>
...
<script>
    function subForm(pageIndex) {
        window.location.href = "RoleServlet?flag=roleAdminmanager&pageIndex=" + pageIndex;
    }
