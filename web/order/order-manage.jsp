    ...
    <div class="bk-con-message message-section" id="iframe_box">
        ...
        <form id="myform" action="OrderServlet" method="post">
            <div class="operation  mb15">
                ...
                订单号:<input type="text" name="orderNo" value="">
                下单日期从:<input type="date" name="date1" value="">到<input type="date" name="date2" value="">
                订单状态:
...
<script>
    function subForm(pageIndex) {
        window.location.href = "OrderServlet?flag=manage&pageIndex=" + pageIndex;
    }
