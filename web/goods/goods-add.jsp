    ...
    <div class="tab-box tabcontent">
        <form action="GoodsServlet" id="myForm" method="post" name="myform" enctype="multipart/form-data">
            <div class="tab-conent prompt_style active">
                <input type="hidden" value="addGoods" name="flag">
                <ul class="clearfix add_style">
                    <li class="cell-item">
                        ...
                        <div class="cell-right">
                            <input type="text" style="font-size:12px;color:#8FA0AC;" class="col-xs-6 col-lg-12"
                                   ...
                                   id="goodsName" name="goodsName" value="${param.goodsName}">
                    ...
                    <li class="cell-item">
                        ...
                        <select id="bigCate" name="bigCateId">
                            ...
                            <c:forEach var="bigcate" items="${cateList}">
                                <c:if test="${bigcate.id==bigCateId}">
                    ...
                    <li class="cell-item">
                        ...
                        <div class="cell-right">
                            <input name="unit" id="unit" onblur="checkunit()" value="${param.unit}" type="text"
                    ...
                    <li class="cell-item">
                        ...
                        <div class="cell-right">
                            <input name="price" id="price" onblur="checkPrice()" value="${param.price}"
                    ...
                    <li class="cell-item">
                        ...
                        <div class="cell-right">
                            <input id="producter" name="producter" value="${param.producter }" type="text" class="col-xs-6 col-lg-12">
                        </div>
                    </li>
                    <li class="cell-item">
                        ...
                        <div class="cell-right">
                            ...
                            <br/>
                            <img id="preview"
                                 src='<%="GoodsServlet?flag=showPicture&goodsId="+request.getAttribute("goodsId") %>'/>
                    ...
                    <li class="cell-item">
                        ...
                        <div class="cell-right">
                            <textarea name="des" id="des"
                                      class="textarea col-xs-4 col-lg-12 height100">${param.des}</textarea>
                        </div>
                    </li>
                </ul>
        ...
        $("#bigCate").on("change", function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        var d = data[i];
                        $("#smallCate").append("<option value=" + d.id + ">" + d.cateName + "</option>")
                    }
                }
            })
        })
