...
<div class="pages-style">
    ...
    <div class="bk-con-message message-section" id="iframe_box">
        <!--编辑内容-->
        <form id="myform" action="MemberServlet" method="post">
            <div class="operation  mb15">
                <input type="hidden" name="flag" value="getMemberByNameAndDate">
                会员帐号:<input type="text" name="memberNo" value="${memberNo}">
                注册日期从:<input type="date" name="date1" value="${date1}">到<input type="date" name="date2" value="${date2}">
            ...
            <div class="page_content clearfix mb15 table-module ">
                <table class="gallery table table_list table_striped table-bordered " id="">
                    ...
                    <c:forEach var="member" items="${memberList}">
                        <tr>
                            <td><label><input type="checkbox" id="id" name="id" value="${member.id}" class="ace"><span
                            ...
                            <td>
                                <a href="MemberServlet?flag=getMember&id=${member.id}">查看</a>
                                |<a href="MemberServlet?flag=deleteMember&id=${member.id}&pageIndex=${page.pageIndex }"
...
<script>
    function subForm(pageIndex) {
        window.location.href = "MemberServlet?flag=getMemberByNameAndDate&pageIndex=" + pageIndex;
    }
